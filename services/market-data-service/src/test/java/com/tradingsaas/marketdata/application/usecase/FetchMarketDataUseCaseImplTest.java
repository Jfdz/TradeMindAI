...
class FetchMarketDataUseCaseImplTest {
    ...
    void fetchHistoricalDataFetchesStoresAndPublishesInOrder() {
        ...
        FetchMarketDataUseCaseImpl useCase =
                new FetchMarketDataUseCaseImpl(marketDataProvider, stockPriceRepository, marketDataEventPublisher);
        ...
        InOrder order = inOrder(marketDataProvider, stockPriceRepository, marketDataEventPublisher);
        ...
        verifyNoMoreInteractions(marketDataProvider, stockPriceRepository, marketDataEventPublisher);
    }
}
