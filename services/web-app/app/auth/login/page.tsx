...
export default function LoginPage() {
  return (
    ...
    >
      <div className="mb-8">
        <p className="text-xs uppercase tracking-[0.35em] text-gold-300/80">Welcome back</p>
        <h2 className="mt-3 text-2xl font-semibold text-white">Access your trading workspace</h2>
